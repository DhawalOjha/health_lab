...
<?php
	...
	if(isset($_POST['button']))//on click on button it will set the value of the $mail to email (see above
     {  
     $qry="select * from admin where email='".$mail."'";//check wheather your email exist on database or not OR you are registered member or not
   ...
   if($res)
   {
	...
	$mail->Body = " Dear Admin Your Password : $pass";
	...
	redirecturl('../adminpanel/index.php'); //if mail sent end
     }
...
redirecturl('../adminpanel/index.php');
	}
}	
?>
</body>
